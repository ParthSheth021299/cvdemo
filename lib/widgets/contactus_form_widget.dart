              ...
              children: [
                ...
                TextFormField(
                  ...
                  decoration: InputDecoration(
                      ...
                      labelText: 'Name'),
                  validator: (value) {
                    if (!validateName && value.toString().length > 0) {
                      validateName = true;
                    }
                    if (value?.isEmpty == true && validateName) {
                ...
                TextFormField(
                  ...
                  validator: (value) {
                    // if (!validateEmail && value!.isEmpty) {
                    ...
                    if (!validateEmail && value.toString().length > 0) {
                      validateEmail = true;
                    }
                    if (value?.isEmpty == true && validateEmail) {
                      return 'Please enter your email';
                    } else if (!RegExp(r'^[\w-\.]+@([\w-]+\.)+[\w-]{2,4}$').hasMatch(value.toString())) {
                      return 'Please enter a valid email';
                    } else {
                ...
                TextFormField(
                  ...
                  validator: (value) {
                    // if (!validatePhoneNumber && value!.isEmpty) {
                    //   return 'Please enter your phone number';
                    // } else if (!RegExp(r'^\d{10}$').hasMatch(value.toString())) {
                    //   return 'Please enter a valid phone number';
                    // }
                    // return null;
                    if (!validatePhoneNumber && value.toString().length > 10) {
                      validatePhoneNumber = true;
                    }
                    if (value?.isEmpty == true && validatePhoneNumber) {
                      return 'Please enter your phone number';
                ...
                TextFormField(
                  ...
                  validator: (value) {
                    // if (!validateMessage && value!.isEmpty) {
                    //   return 'Please enter a message';
                    // }
                    // return null;
                    if (!validateMessage && value.toString().length > 0) {
                      validateMessage = true;
                    }
                    if (value?.isEmpty == true && validateMessage) {
